...
A1 = (r2-r1)*cos(phi1)-l1*cos(phi1)*cos(theta1);
A2 = (r2-r1)*cos(phi2)-l1*cos(phi2)*cos(theta2);
A3 = (r2-r1)*cos(phi3)-l1*cos(phi3)*cos(theta3);
B1 = (r2 - r1)*sin(phi1)-l1*cos(theta1)*sin(phi1);
B2 = (r2 - r1)*sin(phi2)-l1*cos(theta2)*sin(phi2);
B3 = (r2 - r1)*sin(phi3)-l1*cos(theta3)*sin(phi3);
C1 = -l1*sin(theta1);
C2 = -l1*sin(theta2);
C3 = -l1*sin(theta3);
